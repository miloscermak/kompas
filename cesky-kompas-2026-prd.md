...
*(Revize otázek červenec 2026: přeformulace, aby se nepletla prognóza s názorem na ni, jedna otázka osy 1 obrácená kvůli acquiescence bias, otázka 20 vyměněna podle plánu z pilotu.)*

### Osa 1: BRUSEL vs TRUMP

| id | text | pole |
|---|---|---|
| 1 | Rusko napadlo protiprávně Ukrajinu. | +1 |
...
| id | text | pole |
|---|---|---|
| 11 | Dnešní dvacátníci to mají objektivně těžší než jejich rodiče. | -1 |
| 12 | AI změní svět k horšímu. | -1 |
| 13 | Za deset let bude Česko lepší místo k životu než dnes. | +1 |
| 14 | V Evropě bude do několika let válka, ať chceme, nebo nechceme. | -1 |
...
| id | text | pole |
|---|---|---|
| 16 | Bohaté musíme víc zdanit. | -1 |
| 17 | Kdo odmítne nabízenou práci, má přijít o dávky. | +1 |
| 18 | Lidi mají vlastnit jen byty, ve kterých sami bydlí. | -1 |
| 19 | Na vysokých školách se má platit školné. | +1 |
| 20 | Soukromé bazény a klimatizace jsou zlo. | -1 |
...
*(Revize skóre červenec 2026 podle simulace pokrytí — mřížka všech dosažitelných výsledků, cíl: každá figura dosažitelná, žádná nedominuje, kvadrant Trump + Bude líp obsazen. Turek přesunut mezi optimisty — technooptimista, obhájce bazénů a klimatizací. Figury rozprostřeny, aby netvořily dvojčata: Fiala×Pekarová, Zeman×Xaver, Hřib×Nerudová.)*

| name | desc | a1 | a2 | a3 | a4 |
|---|---|---|---|---|---|
| Petr Pavel | prezident, generál ve výslužbě | 8 | 5 | 3 | 2 |
| Andrej Babiš | premiér, šéf ANO | -4 | -7 | 2 | -3 |
| Petr Fiala | expremiér, šéf ODS | 7 | 4 | -2 | 6 |
| Tomio Okamura | šéf SPD | -9 | -9 | -6 | -4 |
| Filip Turek | Motoristé, europoslanec | -8 | -7 | 2 | 6 |
| Kateřina Konečná | šéfka Stačilo!, europoslankyně | -8 | -6 | -4 | -8 |
| Danuše Nerudová | ekonomka, europoslankyně | 9 | 8 | 5 | 0 |
| Zdeněk Hřib | Piráti, náměstek primátora | 6 | 7 | 4 | -1 |
| Vít Rakušan | šéf STAN | 5 | 3 | 1 | 1 |
| Markéta Pekarová Adamová | TOP 09 | 7 | 6 | 1 | 5 |
| Alena Schillerová | ANO, ekonomika | -3 | -5 | 0 | -4 |
| Karel Havlíček | ANO, průmysl | -2 | -4 | 2 | 0 |
| Miloš Zeman | exprezident | -6 | -7 | -4 | -3 |
| Václav Klaus | exprezident | -6 | -7 | -5 | 7 |
| Jindřich Rajchl | šéf PRO | -9 | -8 | -7 | 3 |
| Mikuláš Minář | aktivista, Milion chvilek | 6 | 6 | -2 | -4 |
| Olga Richterová | Piráti | 7 | 6 | 0 | -6 |
| Marian Jurečka | KDU-ČSL | 4 | -2 | 0 | -1 |
| Lubomír Zaorálek | sociální demokrat | 2 | 0 | -2 | -5 |
| Xaver Veselý | moderátor | -5 | -9 | -2 | 0 |
| Daniel Kroupa | filozof, disident | 6 | 2 | -3 | 2 |
| Erik Best | komentátor, Fleet Sheet | -4 | -3 | -1 | 2 |

Poznámka k pokrytí: Jurečka, Zaorálek, Havlíček a Best drží střed mapy (poučení z kritiky Britmonkeyho, kde bez středových figur vyhrával "nejbližší umírněný" defaultně). Kvadrant Trump + Bude líp drží Babiš, Turek a Schillerová.
